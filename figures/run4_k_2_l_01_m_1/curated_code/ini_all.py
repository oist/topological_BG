...
def instantiate_bg(bg_params, fake_inputs=False, ctx_inputs=None,scalefactor=[1,1]):
  ...
  if bg_params['plastic_syn']:
    ...
    bg_params['wr_d1']=nest.Create('weight_recorder',1,{'to_file':True})
    nest.SetDefaults('syn_d1',{'vt':bg_params['vt_d1'][0],#'weight_recorder':bg_params['wr_d1'][0],
    ...
    bg_params['wr_d2']=nest.Create('weight_recorder',1,{'to_file':True})
    nest.SetDefaults('syn_d2',{'vt':bg_params['vt_d2'][0],#'weight_recorder':bg_params['wr_d2'][0],
